...
if (age_1 < age_2)
{console.log("You don't have access cause your age is " + age_2 + " It's less then")}//Если age_1 < age_2, вывести в консоль “You don’t have access cause your age is ” + age_1 + “ It’s less then ”
else if(age_1 >=  age_2,age_1 <  age_3){console.log("Welcome  !")}//Если age_1 >=  age_2 и age_1 <  age_3, вывести в консоль “Welcome  !”
if(age_1  > age_3){console.log("Keep calm and look Culture channel")}//Если age_1  > age_3, вывести в консоль “Keep calm and look Culture channel”
else {console.log("Technical work")}//Иначе выводите “Technical work”
